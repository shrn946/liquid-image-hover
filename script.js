...
// ================================
// Init Hover Effect from data-* attributes
// ================================
document.addEventListener("DOMContentLoaded", function () {
  document.querySelectorAll(".img1").forEach(function (el) {
    const img1 = el.getAttribute("data-image1");
    const img2 = el.getAttribute("data-image2");
    const disp = el.getAttribute("data-displacement");

    if (img1 && img2 && disp) {
      const tempImg = new Image();
      tempImg.src = img1;
      tempImg.onload = function () {
        const ratio = this.naturalHeight / this.naturalWidth; // ✅ real ratio
        new hoverEffect({
          parent: el,
          intensity: 0.3,
          image1: img1,
          ...
          imagesRatio: ratio, // ✅ keeps original shape
        });
      };
    }
  });
